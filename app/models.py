...
class User(PaginatedAPIMixin, UserMixin, db.Model):
    ...
    # Ejemplo de relación self-referential
...
class SearchableMixin(object):
    ...
    #Transforma los IDs en los objetos pertenecientes al ID.
    #Están ordenados según el valor y orden que le dio elasticsearch
    @classmethod
    ...
    #Guardando los cambios para actualizar el IDX de elasticsearch
    @classmethod
    ...
    #Actualizando el IDX correspondiente de elasticsearch
    @classmethod
    ...
    #Encarga de iterar sobre los objetos en la base de datos
    #asociados a la clase, y para cada objeto, lo agrega al
    #índice de búsqueda.
    @classmethod
    def reindex(cls):
